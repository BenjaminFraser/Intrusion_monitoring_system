...
// define smart-post ID - post ID should be 1 less than the post number, i.e. post 1 = 0
#define POST_ID 0
...
// int array to store incoming command post data: commandData = {systemCount, systemReset}
int commandData[2] = {0};
